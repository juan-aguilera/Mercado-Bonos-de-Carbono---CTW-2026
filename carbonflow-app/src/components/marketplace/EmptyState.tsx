...
export function EmptyState({
  ...
  return (
    <div className="rounded-xl border border-dashed border-outline-variant bg-surface-container-lowest p-8 text-center space-y-3">
...
export function ErrorState({
  ...
  return (
    <div className="rounded-xl border border-error/20 bg-error-container/40 p-6 space-y-3">
